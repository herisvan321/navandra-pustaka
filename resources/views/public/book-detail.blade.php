            ...
            <div class="container">
                ...
                <div style="margin-bottom: 30px;">
                    <a href="{{ route('public.books') }}"
                        style="display: inline-flex; align-items: center; gap: 8px; color: var(--gold); text-decoration: none; font-size: 14px; font-weight: 600;">
                        ← Kembali ke Katalog
                    </a>
                </div>
                ...
                <div class="grid-2" style="grid-template-columns: 1fr 1.5fr; gap: 48px; align-items: start;">
                    ...
                    <div>
                        <div class="card"
                            style="padding: 24px; background: var(--off-white); display: flex; justify-content: center; align-items: center; min-height: 400px; border: 1.5px solid var(--border);">
                            @if($book->cover_image)
                                <img src="{{ asset('storage/' . $book->cover_image) }}" alt="{{ $book->title }}"
                                    style="width: 100%; height: auto; border-radius: var(--radius); box-shadow: var(--shadow);">
                            @else
                    ...
                    <div class="book-detail-info">
                        <div class="badge badge-gold" style="margin-bottom: 16px;">{{ $book->category ?? 'Literatur' }}
                        </div>

                        <h1
                            style="font-family: 'Playfair Display', serif; font-size: 36px; font-weight: 900; color: var(--navy); margin-bottom: 8px; line-height: 1.2;">
                            {{ $book->title }}
                        </h1>
                        ...
                        <div
                            style="background: var(--white); border: 1.5px solid var(--border); border-radius: var(--radius); padding: 32px; margin-bottom: 40px; box-shadow: 0 4px 20px rgba(11,29,58,0.04);">
                            <div style="margin-bottom: 24px;">
                                <div style="font-size: 14px; color: var(--text-light); margin-bottom: 4px;">Harga Buku</div>
                                <div
                                    style="font-family: 'Playfair Display', serif; font-size: 28px; font-weight: 900; color: var(--gold);">
                        ...
                        <div style="margin-bottom: 40px;">
                            <h3
                                style="font-family: 'Playfair Display', serif; font-size: 22px; font-weight: 700; color: var(--navy); margin-bottom: 16px; border-bottom: 2px solid var(--border); padding-bottom: 8px;">
                                Deskripsi Buku
                            </h3>
                        ...
                        <div class="grid-2" style="gap: 20px;">
                            ...
                            <div style="padding: 16px; background: var(--off-white); border-radius: 12px;">
                                ...
                                <div style="font-weight: 700; color: var(--navy);">Nevandra Pustaka Nusantara</div>
                            </div>
                            <div style="padding: 16px; background: var(--off-white); border-radius: 12px;">
                                <div style="font-size: 12px; color: var(--text-light); margin-bottom: 4px;">Status</div>
                                <div style="font-weight: 700; color: var(--navy);">{{ $book->status ?: '-' }}</div>
                            </div>
                            <div style="padding: 16px; background: var(--off-white); border-radius: 12px;">
                                <div style="font-size: 12px; color: var(--text-light); margin-bottom: 4px;">Kategory</div>
                                <div style="font-weight: 700; color: var(--navy);">{{ $book->category ?: '-' }}</div>
                            </div>
                ...
                @if($relatedBooks->count() > 0)
                    ...
                    <div style="text-align: center; margin-bottom: 40px;">
                        <h2
                            style="font-family: 'Playfair Display', serif; font-size: 32px; font-weight: 900; color: var(--navy);">
                            Buku <span class="gold">Terkait</span></h2>
                    </div>

                    <div class="book-grid">
                        @foreach($relatedBooks as $related)
                            <div class="book-item">
                                <a href="{{ route('public.books.show', $related->id) }}"
