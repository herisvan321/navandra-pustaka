...
<style>
    ...
    .ql-toolbar {
        ...
        border-color: var(--border-color) !class;
...
<div class="content-header" style="margin-bottom: 25px;">
    <div style="display: flex; align-items: center; gap: 15px;">
        ...
        <h2 style="font-size: 1.5rem; font-weight: 700;">Tulis Berita Baru</h2>
    </div>
</div>
...
<div class="card" style="max-width: 1000px; margin: 0 auto;">
    <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data" id="newsForm">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" value="{{ old('title') }}" required placeholder="Masukkan judul berita..." class="@error('title') invalid @enderror">
        ...
        <div style="display: flex; gap: 15px; justify-content: flex-end; margin-top: 40px; padding-top: 20px; border-top: 1px solid var(--border-color);">
            ...
            <button type="submit" class="btn btn-primary" style="padding: 12px 30px;">Terbitkan Berita</button>
        </div>
    </form>
</div>
@endsection
