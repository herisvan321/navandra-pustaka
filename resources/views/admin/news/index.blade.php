        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        @if($item->image_path)
                            <img src="{{ asset('storage/' . $item->image_path) }}" alt="{{ $item->title }}" style="width: 80px; height: 50px; object-fit: cover; border-radius: 5px;">
                        @else
                            <div style="width: 80px; height: 50px; background: var(--border-color); border-radius: 5px; display: flex; align-items: center; justify-content: center;">
