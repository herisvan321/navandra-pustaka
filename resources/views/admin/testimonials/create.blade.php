...
<div class="content-header" style="margin-bottom: 25px;">
    <div style="display: flex; align-items: center; gap: 15px;">
        ...
        <h2 style="font-size: 1.5rem; font-weight: 700;">Tambah Testimoni</h2>
    </div>
</div>
    ...
    <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid-2">
            <div class="form-group">
                ...
                <input type="text" name="name" value="{{ old('name') }}" required placeholder="E.g. John Doe..." class="@error('name') invalid @enderror">
                @error('name') <span class="error-text">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
                <label>Pekerjaan / Instansi</label>
                <input type="text" name="profession" value="{{ old('profession') }}" placeholder="E.g. Penulis, Dosen..." class="@error('profession') invalid @enderror">
        ...
        <div class="form-group" style="margin-top: 20px;">
            ...
            <textarea name="content" rows="4" required placeholder="Apa kata mereka tentang Nevandra Pustaka?" class="@error('content') invalid @enderror">{{ old('content') }}</textarea>
        ...
        <div class="grid-2" style="margin-top: 20px;">
            ...
            <div class="form-group">
                ...
                <div class="image-preview-wrapper preview-avatar" onclick="document.getElementById('avatarInput').click()" style="cursor: pointer;">
                    ...
                    <img id="avatarPreview" class="preview-img" style="display: none;">
                </div>
        ...
        <div style="display: flex; gap: 15px; justify-content: flex-end; margin-top: 40px; padding-top: 20px; border-top: 1px solid var(--border-color);">
            ...
            <button type="submit" class="btn btn-primary" style="padding: 12px 30px;">Simpan Testimoni</button>
        </div>
    </form>
</div>
@endsection
