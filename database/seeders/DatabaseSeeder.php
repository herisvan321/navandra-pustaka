...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $steps = [
            ...
            ['title' => 'Kirim Naskah & Lakukan Pembayaran DP', 'description' => 'Kirimkan naskah melalui email ke Nevandra.press@gmail.com atau via WhatsApp.', 'note' => 'Subject email: [NASKAH] Nama Judul – Nama Penulis', 'order' => 3],
